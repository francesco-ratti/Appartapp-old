...
class _EditPasswordState extends State<EditPassword> {
  ...
  void doUpdate(Function(String) updateUi, String email, String oldpassword, String newpassword) async {
    var dio = Dio();
    try {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (oldPasswordController.text.trim().isEmpty || password1Controller.text.trim().isEmpty || password2Controller.text.trim().isEmpty) {
                      setState(() {
                    ...
                    if (password1Controller.text!=password2Controller.text) {
                      ...
                      }, RuntimeStore().getEmail() ?? "", oldPassword,
                          newPassword);
                    }
                  }),            Padding(
                  padding: EdgeInsets.all(16.0),
